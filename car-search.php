...
/// Get car brands selected into dropdown list
$brands = get_terms([
    'taxonomy' => 'brands',
    'hide_empty' => true, // Don't display brands which are not having cars...

]); 

if($is_search){
    $query = search_query(); /// call SQL query for search from functions.php
}
                ...
                <form action="<?php echo home_url('/car-search');?>">
                   ...
                   <?php if($is_search): ?>
                    <?php if($query->have_posts()): ?>
                        ...
                        <div class="gallery"> <a href="<?php the_post_thumbnail_url('blog-large'); ?>">
